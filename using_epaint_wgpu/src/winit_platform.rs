...
use emath::Rect;
use epaint::{pos2, text::FontDefinitions, vec2, Pos2};
use winit::{
    dpi::PhysicalSize,
    event::{
...
use crate::kgui::{context::KguiContext, input::RawInput, output::FullOutput};
...
impl Platform {
    ...
    pub fn new(descriptor: PlatformDescriptor) -> Self {
        let context = KguiContext::default();
    ...
    pub fn context(&self) -> KguiContext {
        self.context.clone()
    }
