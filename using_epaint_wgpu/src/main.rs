...
use winit_platform::{Platform, PlatformDescriptor};
...
fn main() {
    ...
    let mut platform = Platform::new(PlatformDescriptor {
        ...
        window_drag_surface_height: None, //Some(App::WINDOW_DRAG_SURFACE_HEIGHT),
    });
    ...
    event_loop.run(move |event, _, control_flow| {
        ...
        match event {
            RedrawRequested(..) => {
                ...
                let _response = draw(&platform.context());
                ...
                let tdelta: epaint::textures::TexturesDelta = full_output.textures_delta;
                egui_rpass
