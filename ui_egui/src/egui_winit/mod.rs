...
impl State {
    ...
    pub fn on_event(
        ...
        match event {
                ...
                match &event.logical_key {
                    ...
                    _ => {
                        ...
                        let consumed = egui_ctx.wants_keyboard_input()
                            || event.logical_key == keyboard::Key::Tab;
            ...
            _ => {
                // todo add back file drag/drop handling
                EventResponse {
                    repaint: false,
                    consumed: false,
                }
    ...
    fn on_keyboard_input(&mut self, event: &winit::event::KeyEvent) {
        ...
        if pressed {
            ...
            if is_cut_command(self.egui_input.modifiers, &event.logical_key) {
                self.egui_input.events.push(egui::Event::Cut);
            } else if is_copy_command(self.egui_input.modifiers, &event.logical_key) {
                self.egui_input.events.push(egui::Event::Copy);
            } else if is_paste_command(self.egui_input.modifiers, &event.logical_key) {
        ...
        if let Some(key) = translate_virtual_key_code(&event.logical_key) {
...
fn translate_mouse_button(button: winit::event::MouseButton) -> Option<egui::PointerButton> {
    match button {
        winit::event::MouseButton::Left | winit::event::MouseButton::Back => {
            Some(egui::PointerButton::Primary)
        }
        winit::event::MouseButton::Right | winit::event::MouseButton::Forward => {
...
fn translate_virtual_key_code(key: &keyboard::Key) -> Option<egui::Key> {
    ...
    Some(match key {
        ...
        keyboard::Key::Character(ch) if ch.as_str() == "-" => Key::Minus,
        // Using Mac the key with the Plus sign on it is reported as the Equals key
        // (with both English and Swedish keyboard).
        keyboard::Key::Character(ch) if ch.as_str() == "=" => Key::PlusEquals,

        // keyboard::Key::Character(ch) 0 => Key::Num0,
        // keyboard::Key::Character(ch) 1 => Key::Num1,
        // keyboard::Key::Character(ch) 2 => Key::Num2,
        // keyboard::Key::Character(ch) 3 => Key::Num3,
        // keyboard::Key::Character(ch) 4 => Key::Num4,
        // keyboard::Key::Character(ch) 5 => Key::Num5,
        // keyboard::Key::Character(ch) 6 => Key::Num6,
        // keyboard::Key::Character(ch) 7 => Key::Num7,
        // keyboard::Key::Character(ch) 8 => Key::Num8,
        // keyboard::Key::Character(ch) 9 => Key::Num9,
        //
        // keyboard::Key::A => Key::A,
        // keyboard::Key::B => Key::B,
        // keyboard::Key::C => Key::C,
        // keyboard::Key::D => Key::D,
        // keyboard::Key::E => Key::E,
        // keyboard::Key::F => Key::F,
        // keyboard::Key::G => Key::G,
        // keyboard::Key::H => Key::H,
        // keyboard::Key::I => Key::I,
        // keyboard::Key::J => Key::J,
        // keyboard::Key::K => Key::K,
        // keyboard::Key::L => Key::L,
        // keyboard::Key::M => Key::M,
        // keyboard::Key::N => Key::N,
        // keyboard::Key::O => Key::O,
        // keyboard::Key::P => Key::P,
        // keyboard::Key::Q => Key::Q,
        // keyboard::Key::R => Key::R,
        // keyboard::Key::S => Key::S,
        // keyboard::Key::T => Key::T,
        // keyboard::Key::U => Key::U,
        // keyboard::Key::V => Key::V,
        // keyboard::Key::W => Key::W,
        // keyboard::Key::X => Key::X,
        // keyboard::Key::Y => Key::Y,
        // keyboard::Key::Z => Key::Z,
        //
